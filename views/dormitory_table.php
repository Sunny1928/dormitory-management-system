...
<div class="card m-2 px-4 py-3">
  <div class="d-flex justify-content-between">
    ...
    <button class='btn ms-2 btn-primary btn-sm' data-mdb-toggle='modal' data-mdb-target='#addDormitoryModal'><i class='fa fa-add me-1'></i>新增</button>
  </div>
</div>
                      ...
                      <div class='modal-body'>
                        <div class='text-center mb-3'>
                          <div class='form-outline mb-4'>
                            <input value='$id' required readonly type='text' name='dormitory_id' class='form-control' />
                            <label class='form-label'>宿舍編號</label>
                          </div>
                          <div class='form-outline mb-4'>
                    ...
                    <div class='modal-dialog modal-dialog-centered'>
                      <form method='post' action='./controller/dormitory_controller.php'>
                        <div class='modal-content'>
                          ...
                          <div class='modal-footer'>
                            <input value='$id' required type='hidden' name='dormitory_id' class='form-control' />
                            <button type='button' class='btn btn-secondary' data-mdb-dismiss='modal'>取消</button>
