              ...
              if (mysqli_num_rows($result) > 0) 
              {
                while ($info = mysqli_fetch_assoc($result)) 
                {
                  ...
                  echo "<tr>" .
                    ...
                    "<td>
                      <button onclick=\"put_admin('$name','$account','$email','$phone','$gender')\" class='call-btn btn btn-outline-primary btn-floating btn-sm ripple-surface' data-mdb-toggle='modal' data-mdb-target='#updateSystemAdminModal'><i class='fa fa-pencil'></i></button>
                      <button onclick=\"put_admin('$name','$account','$email','$phone','$gender')\" class='message-btn btn ms-2 btn-primary btn-floating btn-sm' data-mdb-toggle='modal' data-mdb-target='#deleteSystemAdminModal'><i class='fa fa-trash'></i></button>
                    </td>".
                    "</tr>";
...
// Update Modal
echo "
<div class='modal fade' id='updateSystemAdminModal' tabindex='-1' aria-labelledby='updateSystemAdminModalLabel' aria-hidden='true'>
  <div class='modal-dialog modal-dialog-centered'>
  <div class='modal-content'>
  <form method='post' action='./controller/user_controller.php'>
  <div class='modal-header'>
...
<!-- Delete  Modal -->
<div class='modal fade' id='deleteSystemAdminModal' tabindex='-1' aria-labelledby='deleteSystemAdminModalLabel' aria-hidden='true'>
  <div class='modal-dialog modal-dialog-centered'>
      <div class='modal-content'>
    <form method='post' action='./controller/user_controller.php'>
    <div class='modal-header'>
...
<script>
function put_admin(a, b, c, d, e, f){
