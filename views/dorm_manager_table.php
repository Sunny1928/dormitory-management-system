              ...
              if (mysqli_num_rows($result) > 0) 
              {
                while ($info = mysqli_fetch_assoc($result)) 
                {
                  ...
                  echo "<tr>" .
                    ...
                    "<td>
                      <button class='call-btn btn btn-outline-primary btn-floating btn-sm ripple-surface' data-mdb-toggle='modal' data-mdb-target='#updateDormManagerModal$account'><i class='fa fa-pencil'></i></button>
                      <button class='message-btn btn ms-2 btn-primary btn-floating btn-sm' data-mdb-toggle='modal' data-mdb-target='#deleteDormManagerModal$account'><i class='fa fa-trash'></i></button>
                    </td>".
                    "</tr>";

                  // Update Modal
                  echo "
                  <div class='modal fade' id='updateDormManagerModal$account' tabindex='-1' aria-labelledby='updateDormManagerModalLabel' aria-hidden='true'>
                  ...
                  // Delete  Modal
                  echo "
                  <div class='modal fade' id='deleteDormManagerModal$account' tabindex='-1' aria-labelledby='deleteDormManagerModalLabel' aria-hidden='true'>
                    <div class='modal-dialog modal-dialog-centered'>
                      <form method='post' action='./controller/user_controller.php'>
                        <div class='modal-content'>
                          <div class='modal-header'>
