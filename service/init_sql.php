<?php
    ...
    function add_student($conn){
        ...
        for($i=1;$i<=99;$i++){
            ...
            student_create($conn,$name[3*($i-1)]  ,'A10955'.$i,'A10955'.$i.'@asdasdasda','0987654321','A10955'.$i,$gender,3,'CSIE');
            student_create($conn,$name[3*($i-1)+1],'A10951'.$i,'A10951'.$i.'@fdfdsfasad','0987654321','A10951'.$i,$gender,3,'EE');
            student_create($conn,$name[3*($i-1)+2],'A10940'.$i,'A10940'.$i.'@fdfdsfasad','0987654321','A10940'.$i,$gender,3,'CE');
    ...
    function add_apply_dorm($conn){
        ...
        for($i=1;$i<=99;$i++){
            ...
            if($i < 10 ) {    
                ...
                apply_dorm_create($conn , "A10940".$i,110,0,1);
            }
            else if($i >= 10 && $i < 60) {
                
                apply_dorm_create($conn , "A10955".$i,110,1,2);
                apply_dorm_create($conn , "A10951".$i,110,1,2);
                apply_dorm_create($conn , "A10940".$i,110,1,2);
            }
            else if($i >= 60 && $i < 90) {
                
                apply_dorm_create($conn , "A10955".$i,110,2,3);
                apply_dorm_create($conn , "A10951".$i,110,2,3);
                apply_dorm_create($conn , "A10940".$i,110,2,3);
            }
            else if($i >= 90 && $i <= 99) {
                
                apply_dorm_create($conn , "A10955".$i,110,3,0);
                apply_dorm_create($conn , "A10951".$i,110,3,0);
                apply_dorm_create($conn , "A10940".$i,110,3,0);
            }
        }
